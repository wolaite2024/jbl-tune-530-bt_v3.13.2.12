...
#define HARMAN_LICENSE_SIZE_SAVE_TO_FTL     (HARMAN_SERIALS_NUM_LEN + HARMAN_PRODUCT_ID_LEN + HARMAN_COLOR_ID_LEN + HARMAN_MODLE_ID_LEN + HARMAN_MANUFACTURER_LEN + HARMAN_RESVED_LEN)
...
typedef enum _t_app_harman_spp_sub_cmd_id
{
    ...
    HARMAN_SPP_SUB_CMD_MODULE_ID_SET            = 0x04,
    HARMAN_SPP_SUB_CMD_MANUFACTURER_SET         = 0x05,

    HARMAN_SPP_SUB_CMD_PID_GET                  = 0x11,
    HARMAN_SPP_SUB_CMD_CID_GET                  = 0x12,
    HARMAN_SPP_SUB_CMD_SERIALS_NUM_GET          = 0x13,
    HARMAN_SPP_SUB_CMD_MODULE_ID_GET            = 0x14,  
    HARMAN_SPP_SUB_CMD_MANUFACTURER_GET         = 0x15,    
