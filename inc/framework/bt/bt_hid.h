 ...
 * \ingroup BT_HID
 */
bool bt_hid_init(uint8_t link_num,
 ...
 * \ingroup BT_HID
 */
bool bt_hid_descriptor_set(const uint8_t *descriptor,
                           uint16_t       len);
 ...
 * \ingroup BT_HID
 */
bool bt_hid_connect_req(uint8_t bd_addr[6]);
 ...
 * \ingroup BT_HID
 */
bool bt_hid_connect_cfm(uint8_t bd_addr[6],
                        bool    accept);
 ...
 * \ingroup BT_HID
 */
bool bt_hid_disconnect_req(uint8_t bd_addr[6]);
 ...
 * \ingroup BT_HID
 */
bool bt_hid_control_get_report_rsp(uint8_t               bd_addr[6],
 ...
 * \ingroup BT_HID
 */
bool bt_hid_control_get_protocol_rsp(uint8_t                bd_addr[6],
 ...
 * \ingroup BT_HID
 */
bool bt_hid_interrupt_data_send(uint8_t               bd_addr[6],
                                T_BT_HID_REPORT_TYPE  report_type,
                                uint8_t              *buf,
                                uint16_t              len);
