...
typedef enum t_bt_event
{
    ...
    */
    ...
    /**
     * \brief Indicate HFP vendor AT command result \ref T_BT_EVENT_PARAM_HFP_VENDOR_COMMAND_RESULT.
     */
    BT_EVENT_HFP_VENDOR_COMMAND_RESULT                = 0x3412,
    ...
    */
    BT_EVENT_HFP_AG_NREC_STATUS                       = 0x34b9,

    /**
    * \brief Indicate HFP AG received unknown AT command \ref T_BT_EVENT_PARAM_HFP_AG_UNKNOWN_AT_CMD.
    */
    BT_EVENT_HFP_AG_UNKNOWN_AT_CMD                    = 0x34ba,
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hfp_vendor_command_result
{
    uint8_t                bd_addr[6];
    T_BT_HFP_CMD_RESULT    result;
} T_BT_EVENT_PARAM_HFP_VENDOR_COMMAND_RESULT;
 ...
 * btm.h
 *
 * \brief  BT manager event parameter HFP AG received unknown at command.
 *
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hfp_ag_unknown_at_cmd
{
    uint8_t  bd_addr[6];
    uint8_t *at_cmd;
    uint16_t at_len;
} T_BT_EVENT_PARAM_HFP_AG_UNKNOWN_AT_CMD;
...
typedef union
{
    ...
    T_BT_EVENT_PARAM_HFP_VENDOR_COMMAND_RESULT             hfp_vendor_command_result;
    ...
    T_BT_EVENT_PARAM_HFP_AG_UNKNOWN_AT_CMD              hfp_ag_unknown_at_cmd;
 ...
 * \param[in] p_data     SCO buffer to send.
